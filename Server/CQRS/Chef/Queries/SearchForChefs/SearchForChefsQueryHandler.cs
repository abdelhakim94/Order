                ...
                query = query.Where(u => u.FirstName.ToLower().Contains(search)
                    ...
                    || u.Cards.Any(c => c.IsActive && (c.Name.ToLower().Contains(search)
                        || c.CardDishes.Any(cd => cd.Dish.Name.ToLower().Contains(search)
                            ...
                            || cd.Dish.DishOptions.Any(dop => dop.Option.Name.ToLower().Contains(search))
                            || cd.Dish.DishExtras.Any(de => de.Extra.Name.ToLower().Contains(search)))
                        || c.CardMenus.Any(cm => cm.Menu.Name.ToLower().Contains(search)
                            ...
                            || cm.Menu.MenuOptions.Any(mo => mo.Option.Name.ToLower().Contains(search))
                            || cm.Menu.MenuExtras.Any(me => me.Extra.Name.ToLower().Contains(search))
